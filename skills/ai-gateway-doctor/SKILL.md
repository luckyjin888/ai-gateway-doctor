...
8. Re-run diagnostics and perform private chat, group mention, outbound delivery, and restart-persistence acceptance tests.
...
- Do not set allow-all as a shortcut. Prefer explicit user IDs and scoped chats.
